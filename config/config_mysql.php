...
class ManajemenInventaris {
    ...
    public function catatBarangMasuk($namaBarang, $jumlah, $harga, $tanggal) {
        try {
            ...
            // Insert transaksi
            $query = "INSERT INTO transaksi (jenis, nama_barang, jumlah, harga, tanggal) 
                      VALUES ('MASUK', :nama_barang, :jumlah, :harga, :tanggal)";
            ...
            if ($stmtCheck->rowCount() > 0) {
                ...
                // Insert barang baru
                $queryInsert = "INSERT INTO barang (nama_barang, stok) VALUES (:nama_barang, :stok)";
    ...
    public function catatBarangKeluar($namaBarang, $jumlah, $harga, $tanggal, $bagian = '', $penanggungJawab = '') {
        try {
            ...
            // Insert transaksi
            $query = "INSERT INTO transaksi (jenis, nama_barang, jumlah, harga, tanggal, bagian, penanggung_jawab) 
                      VALUES ('KELUAR', :nama_barang, :jumlah, :harga, :tanggal, :bagian, :penanggung_jawab)";
            $stmt = $this->conn->prepare($query);
            $stmt->bindParam(':nama_barang', $namaBarang);
            $stmt->bindParam(':jumlah', $jumlah);
            $stmt->bindParam(':harga', $harga);
    ...
    public function getDaftarBarang() {
        $query = "SELECT b.nama_barang, b.stok, 
